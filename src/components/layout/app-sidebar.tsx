...
const grupos = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Patrimônio", url: "/patrimonio", icon: Boxes },
      { title: "Abastecimentos", url: "/abastecimentos", icon: Fuel },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Despesas", url: "/despesas", icon: ReceiptText },
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="truncate text-[11px] text-sidebar-foreground/60">Gestão de Transporte</p>
            </div>
          )}
        </div>
      </SidebarHeader>
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="min-w-0 text-[11px] leading-tight text-sidebar-foreground/65">
              <p className="truncate font-medium text-sidebar-foreground">Plano Corporativo</p>
              <p className="truncate">Licença até 12/2026</p>
            </div>
          )}
        </div>
      </SidebarFooter>
